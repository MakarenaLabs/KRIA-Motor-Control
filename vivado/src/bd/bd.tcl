...
proc create_root_design { parentCell } {
  ...
  set_property PFM_NAME {xilinx.com:xd:zcu104_foc:1.0} [get_files [current_bd_design].bd]
  ...
  set_property PFM.AXIS_PORT {S_AXIS {type "S_AXIS" sptag "tx_fifo_S_AXIS"}} [get_bd_cells /tx_fifo]
   ...
   # add Voltage support for Field Weakning
   startgroup
   set_property -dict [list CONFIG.M_TDATA_NUM_BYTES {8} CONFIG.TDATA_REMAP {tdata[63:0]}] [get_bd_cells Ib_Ia]
   endgroup
   startgroup
   set_property -dict [list CONFIG.C_A_TDATA_WIDTH {64}] [get_bd_cells axis_concat_0]
   endgroup
   startgroup
   set_property -dict [list CONFIG.M_TDATA_WIDTH {96}] [get_bd_cells axis_concat_0]
   endgroup
   startgroup
   set_property -dict [list CONFIG.TDATA_NUM_BYTES {12}] [get_bd_cells rx_fifo]
   endgroup
   startgroup
   set_property -dict [list CONFIG.M_TDATA_NUM_BYTES {6} CONFIG.TDATA_REMAP {tdata[47:0]}] [get_bd_cells Ib_Ia]
   endgroup
   startgroup
   set_property -dict [list CONFIG.C_A_TDATA_WIDTH {48} CONFIG.M_TDATA_WIDTH {80}] [get_bd_cells axis_concat_0]
   endgroup
   startgroup
...
delete_bd_objs [get_bd_nets psu_pl_clk2] [get_bd_nets processing_system7_0_FCLK_CLK1]
connect_bd_net [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins axi_interconnect_0/ACLK]
connect_bd_net [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins axi_interconnect_0/S00_ACLK]
connect_bd_net [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins axi_interconnect_0/M00_ACLK]
connect_bd_net [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins axi_datamover_0/m_axi_s2mm_aclk]
connect_bd_net [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins axi_datamover_0/m_axis_s2mm_cmdsts_awclk]
connect_bd_net [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins AXI_StreamCapture_0/axi_aclk]
connect_bd_net [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins clk_wiz_1/clk_out2]
connect_bd_net [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins clk_wiz_1/clk_out2]
connect_bd_net [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins clk_wiz_1/clk_out2]
connect_bd_net [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins clk_wiz_1/clk_out2]
connect_bd_net [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins psu/maxihpm1_fpd_aclk]
connect_bd_net [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins psu/saxihp3_fpd_aclk]
connect_bd_net [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins clk_wiz_0/clk_in1]
connect_bd_net [get_bd_pins vio_0/clk] [get_bd_pins clk_wiz_1/clk_out2]
connect_bd_net [get_bd_pins clk_mux_0/clk0] [get_bd_pins clk_wiz_1/clk_out2]
connect_bd_net [get_bd_pins axis_data_fifo_0/m_axis_aclk] [get_bd_pins clk_wiz_1/clk_out2]
connect_bd_net [get_bd_pins proc_sys_reset_2/slowest_sync_clk] [get_bd_pins clk_wiz_1/clk_out2]
connect_bd_net [get_bd_pins axis_concat_0/s_axis_aclk] [get_bd_pins clk_wiz_1/clk_out2]
connect_bd_net [get_bd_pins rx_fifo/s_axis_aclk] [get_bd_pins clk_wiz_1/clk_out2]
connect_bd_net [get_bd_pins PWM/s_axis_aclk] [get_bd_pins clk_wiz_1/clk_out2]
connect_bd_net [get_bd_pins tx_fifo/s_axis_aclk] [get_bd_pins clk_wiz_1/clk_out2]
