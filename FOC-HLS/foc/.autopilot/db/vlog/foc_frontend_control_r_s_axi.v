...
#(parameter
    ...
    input  wire [4:0]                    logger_address0,
...
//------------------------Local signal-------------------
    ...
    wire [4:0]                    int_logger_address0;
    wire                          int_logger_ce0;
    wire [3:0]                    int_logger_be0;
    wire [31:0]                   int_logger_d0;
    wire [4:0]                    int_logger_address1;
    wire                          int_logger_ce1;
...
assign int_logger_address1  = ar_hs? raddr[6:2] : waddr[6:2];
