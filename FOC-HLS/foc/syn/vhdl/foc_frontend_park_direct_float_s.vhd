...
entity foc_frontend_park_direct_float_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of foc_frontend_park_direct_float_s is 
...
attribute shreg_extract : string;
    ...
    signal sin_angle_reg_372 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal cos_angle_reg_378 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal grp_fu_88_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal Ialpha_cos_reg_396 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal grp_fu_93_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal Ialpha_sin_reg_401 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_98_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal Ibeta_cos_reg_406 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_103_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal Ibeta_sin_reg_411 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal dc_5_reg_424 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_10_reg_444 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_fu_119_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_s_reg_449 : STD_LOGIC_VECTOR (0 downto 0);
    signal bitcast_ln354_2_fu_201_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_13_reg_466 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_fu_129_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_14_reg_471 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_9_reg_476 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state12 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state12 : signal is "none";
    signal tmp_12_reg_486 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln30_2_fu_178_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln30_fu_172_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal data_V_5_fu_190_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_Result_5_fu_193_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal zext_ln368_2_fu_197_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_11_fu_206_p4 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln34_fu_216_p1 : STD_LOGIC_VECTOR (22 downto 0);
    signal icmp_ln34_2_fu_226_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln34_fu_220_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln12_fu_238_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln12_4_fu_246_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln12_fu_242_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal zext_ln12_4_fu_250_p1 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal and_ln12_5_fu_283_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln12_6_fu_291_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln12_5_fu_287_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal zext_ln12_6_fu_295_p1 : STD_LOGIC_VECTOR (1 downto 0);
    signal sub_ln12_2_fu_299_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal shl_ln2_fu_309_p3 : STD_LOGIC_VECTOR (16 downto 0);
    ...
    component foc_frontend_park_direct_float_s_sine_d_ROM_AUTO_1R IS
    generic (
        DataWidth : INTEGER;
    ...
    component foc_frontend_park_direct_float_s_cosine_d_ROM_AUTO_1R IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    sine_d_U : component foc_frontend_park_direct_float_s_sine_d_ROM_AUTO_1R
    generic map (
        DataWidth => 32,
        AddressRange => 1000,
        AddressWidth => 10)
    ...
    cosine_d_U : component foc_frontend_park_direct_float_s_cosine_d_ROM_AUTO_1R
    generic map (
        DataWidth => 32,
        AddressRange => 1000,
        AddressWidth => 10)
    ...
    fadd_32ns_32ns_32_4_full_dsp_1_U33 : component foc_frontend_fadd_32ns_32ns_32_4_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst,
        din0 => Ialpha_cos_reg_396,
        din1 => Ibeta_sin_reg_411,
        ce => ap_const_logic_1,
        dout => grp_fu_80_p2);

    fsub_32ns_32ns_32_4_full_dsp_1_U34 : component foc_frontend_fsub_32ns_32ns_32_4_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst,
        din0 => Ibeta_cos_reg_406,
        din1 => Ialpha_sin_reg_401,
        ce => ap_const_logic_1,
        dout => grp_fu_84_p2);

    fmul_32ns_32ns_32_3_max_dsp_1_U35 : component foc_frontend_fmul_32ns_32ns_32_3_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst,
        din0 => cos_angle_reg_378,
        din1 => Ialpha,
        ce => ap_const_logic_1,
        dout => grp_fu_88_p2);

    fmul_32ns_32ns_32_3_max_dsp_1_U36 : component foc_frontend_fmul_32ns_32ns_32_3_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst,
        din0 => sin_angle_reg_372,
        din1 => Ialpha,
        ce => ap_const_logic_1,
        dout => grp_fu_93_p2);

    fmul_32ns_32ns_32_3_max_dsp_1_U37 : component foc_frontend_fmul_32ns_32ns_32_3_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    sitofp_32s_32_4_no_dsp_1_U39 : component foc_frontend_sitofp_32s_32_4_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    sitofp_32s_32_4_no_dsp_1_U40 : component foc_frontend_sitofp_32s_32_4_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fcmp_32ns_32ns_1_2_no_dsp_1_U41 : component foc_frontend_fcmp_32ns_32ns_1_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    fcmp_32ns_32ns_1_2_no_dsp_1_U42 : component foc_frontend_fcmp_32ns_32ns_1_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    fcmp_32ns_32ns_1_2_no_dsp_1_U43 : component foc_frontend_fcmp_32ns_32ns_1_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    fcmp_32ns_32ns_1_2_no_dsp_1_U44 : component foc_frontend_fcmp_32ns_32ns_1_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state5)) then
                Ialpha_cos_reg_396 <= grp_fu_88_p2;
                Ialpha_sin_reg_401 <= grp_fu_93_p2;
                Ibeta_cos_reg_406 <= grp_fu_98_p2;
                Ibeta_sin_reg_411 <= grp_fu_103_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                cos_angle_reg_378 <= cosine_d_q0;
                sin_angle_reg_372 <= sine_d_q0;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state11)) then
                ...
                tmp_10_reg_444 <= grp_fu_114_p2;
                tmp_13_reg_466 <= grp_fu_124_p2;
                tmp_14_reg_471 <= grp_fu_129_p2;
                tmp_s_reg_449 <= grp_fu_119_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state12)) then
                tmp_12_reg_486 <= grp_fu_119_p2;
                tmp_9_reg_476 <= grp_fu_114_p2;
            end if;
        end if;
    end process;
    ...
    and_ln12_4_fu_246_p2 <= (tmp_s_reg_449 and or_ln30_reg_437);
    and_ln12_5_fu_283_p2 <= (tmp_13_reg_466 and or_ln34_reg_459);
    and_ln12_6_fu_291_p2 <= (tmp_14_reg_471 and or_ln34_reg_459);
    and_ln12_fu_238_p2 <= (tmp_10_reg_444 and or_ln30_reg_437);
    and_ln30_fu_328_p2 <= (tmp_9_reg_476 and or_ln30_reg_437);
    and_ln34_fu_339_p2 <= (tmp_12_reg_486 and or_ln34_reg_459);
    ...
    bitcast_ln354_2_fu_201_p1 <= zext_ln368_2_fu_197_p1;
    bitcast_ln354_fu_153_p1 <= zext_ln368_fu_149_p1;
    cosine_d_address0 <= zext_ln19_fu_136_p1(10 - 1 downto 0);
    ...
    data_V_5_fu_190_p1 <= dc_5_reg_424;
    ...
    grp_fu_119_p0_assign_proc : process(dc_reg_416, ap_CS_fsm_state11, bitcast_ln354_2_fu_201_p1, ap_CS_fsm_state10)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state11)) then 
            grp_fu_119_p0 <= bitcast_ln354_2_fu_201_p1;
        elsif ((ap_const_logic_1 = ap_CS_fsm_state10)) then 
    ...
    icmp_ln30_2_fu_178_p2 <= "1" when (trunc_ln30_fu_168_p1 = ap_const_lv23_0) else "0";
    icmp_ln30_fu_172_p2 <= "0" when (tmp_fu_158_p4 = ap_const_lv8_FF) else "1";
    icmp_ln34_2_fu_226_p2 <= "1" when (trunc_ln34_fu_216_p1 = ap_const_lv23_0) else "0";
    icmp_ln34_fu_220_p2 <= "0" when (tmp_11_fu_206_p4 = ap_const_lv8_FF) else "1";
    or_ln30_fu_184_p2 <= (icmp_ln30_fu_172_p2 or icmp_ln30_2_fu_178_p2);
    or_ln34_fu_232_p2 <= (icmp_ln34_fu_220_p2 or icmp_ln34_2_fu_226_p2);
    p_Result_5_fu_193_p1 <= data_V_5_fu_190_p1(31 - 1 downto 0);
    ...
    select_ln34_fu_343_p3 <= 
        ...
        sext_ln35_fu_305_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sub_ln12_2_fu_299_p2),17));

    shl_ln2_fu_309_p3 <= (sub_ln12_2_fu_299_p2 & ap_const_lv15_0);
    shl_ln_fu_264_p3 <= (sub_ln12_fu_254_p2 & ap_const_lv15_0);
    sine_d_address0 <= zext_ln19_fu_136_p1(10 - 1 downto 0);
    ...
    sub_ln12_2_fu_299_p2 <= std_logic_vector(unsigned(zext_ln12_5_fu_287_p1) - unsigned(zext_ln12_6_fu_295_p1));
    sub_ln12_fu_254_p2 <= std_logic_vector(unsigned(zext_ln12_fu_242_p1) - unsigned(zext_ln12_4_fu_250_p1));
    sub_ln31_fu_272_p2 <= std_logic_vector(unsigned(shl_ln_fu_264_p3) - unsigned(sext_ln31_fu_260_p1));
    sub_ln35_fu_317_p2 <= std_logic_vector(unsigned(shl_ln2_fu_309_p3) - unsigned(sext_ln35_fu_305_p1));
    tmp_11_fu_206_p4 <= data_V_5_fu_190_p1(30 downto 23);
    tmp_fu_158_p4 <= data_V_fu_142_p1(30 downto 23);
    trunc_ln30_fu_168_p1 <= data_V_fu_142_p1(23 - 1 downto 0);
    trunc_ln34_fu_216_p1 <= data_V_5_fu_190_p1(23 - 1 downto 0);
    zext_ln12_4_fu_250_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(and_ln12_4_fu_246_p2),2));
    zext_ln12_5_fu_287_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(and_ln12_5_fu_283_p2),2));
    zext_ln12_6_fu_295_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(and_ln12_6_fu_291_p2),2));
    ...
    zext_ln368_2_fu_197_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_Result_5_fu_193_p1),32));
