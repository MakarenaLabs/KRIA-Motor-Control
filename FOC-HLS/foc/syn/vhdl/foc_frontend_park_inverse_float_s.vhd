...
entity foc_frontend_park_inverse_float_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of foc_frontend_park_inverse_float_s is 
...
attribute shreg_extract : string;
    ...
    signal Vd_cos_reg_396 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal grp_fu_93_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal Vd_sin_reg_401 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_98_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal Vq_cos_reg_406 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_103_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal Vq_sin_reg_411 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_3_reg_449 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_7_reg_466 : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_fu_129_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_8_reg_471 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_1_reg_476 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state12 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state12 : signal is "none";
    signal tmp_6_reg_486 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    sine_i_U : component foc_frontend_park_direct_float_s_sine_d_ROM_AUTO_1R
    generic map (
        DataWidth => 32,
        AddressRange => 1000,
        AddressWidth => 10)
    ...
    cosine_i_U : component foc_frontend_park_direct_float_s_cosine_d_ROM_AUTO_1R
    generic map (
        DataWidth => 32,
        AddressRange => 1000,
        AddressWidth => 10)
    ...
    fsub_32ns_32ns_32_4_full_dsp_1_U71 : component foc_frontend_fsub_32ns_32ns_32_4_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fadd_32ns_32ns_32_4_full_dsp_1_U72 : component foc_frontend_fadd_32ns_32ns_32_4_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fmul_32ns_32ns_32_3_max_dsp_1_U73 : component foc_frontend_fmul_32ns_32ns_32_3_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fmul_32ns_32ns_32_3_max_dsp_1_U74 : component foc_frontend_fmul_32ns_32ns_32_3_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fmul_32ns_32ns_32_3_max_dsp_1_U75 : component foc_frontend_fmul_32ns_32ns_32_3_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fmul_32ns_32ns_32_3_max_dsp_1_U76 : component foc_frontend_fmul_32ns_32ns_32_3_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    sitofp_32s_32_4_no_dsp_1_U77 : component foc_frontend_sitofp_32s_32_4_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fcmp_32ns_32ns_1_2_no_dsp_1_U79 : component foc_frontend_fcmp_32ns_32ns_1_2_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state5)) then
                Vd_cos_reg_396 <= grp_fu_88_p2;
                Vd_sin_reg_401 <= grp_fu_93_p2;
                Vq_cos_reg_406 <= grp_fu_98_p2;
                Vq_sin_reg_411 <= grp_fu_103_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                cos_angle_reg_378 <= cosine_i_q0;
                sin_angle_reg_372 <= sine_i_q0;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state11)) then
                ...
                tmp_2_reg_444 <= grp_fu_114_p2;
                tmp_3_reg_449 <= grp_fu_119_p2;
                tmp_7_reg_466 <= grp_fu_124_p2;
                tmp_8_reg_471 <= grp_fu_129_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state12)) then
                tmp_1_reg_476 <= grp_fu_114_p2;
                tmp_6_reg_486 <= grp_fu_119_p2;
            end if;
        end if;
    end process;
    ...
    and_ln12_1_fu_246_p2 <= (tmp_3_reg_449 and or_ln30_reg_437);
    and_ln12_2_fu_283_p2 <= (tmp_7_reg_466 and or_ln34_reg_459);
    and_ln12_3_fu_291_p2 <= (tmp_8_reg_471 and or_ln34_reg_459);
    and_ln12_fu_238_p2 <= (tmp_2_reg_444 and or_ln30_reg_437);
    and_ln30_fu_328_p2 <= (tmp_1_reg_476 and or_ln30_reg_437);
    and_ln34_fu_339_p2 <= (tmp_6_reg_486 and or_ln34_reg_459);
    ...
    icmp_ln34_fu_220_p2 <= "0" when (tmp_4_fu_206_p4 = ap_const_lv8_FF) else "1";
    ...
    tmp_4_fu_206_p4 <= data_V_4_fu_190_p1(30 downto 23);
    ...
    zext_ln368_1_fu_197_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_Result_4_fu_193_p1),32));
