...
module foc_sin_or_cos_float_Pipeline_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_idle;
output   ap_ready;
input  [31:0] p_Result_10;
input  [31:0] p_Result_7;
...
assign p_Val2_s_fu_108_p3 = ((trunc_ln553_fu_104_p1[0:0] == 1'b1) ? p_Result_10 : p_Result_7);

assign trunc_ln553_fu_104_p1 = ap_sig_allocacmp_i_2[0:0];

endmodule //foc_sin_or_cos_float_Pipeline_1
